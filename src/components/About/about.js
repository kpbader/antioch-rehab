    ...
    return (
        <section id="about-page">
            <div id="about-top">
                <Fade up>
                    <h2>About Us</h2>
                    <p>Antioch Rehab provides a quiet, calm, and safe place to journey towards healing. We believe that in reducing substance abuse and other behavioral health complications among adults by providing addiction treatment services.</p>
