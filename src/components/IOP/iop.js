...
import flowerField from '../../assets/images/raquel-pedrotti-hB-Vwbyxr9U-unsplash.jpg';
import rJames from '../../assets/images/richard-james-tr1G_ZxfK68-unsplash.jpg';
import danielR from "../../assets/images/daniel-roe-lpjb_UMOyx8-unsplash.jpg";
        ...
        <section id="iop-page">
            <div id="iop-top">
                <Fade up>
                    ...
                    <p>At Antioch Rehab, we recognize that overcoming addiction on your own may not be possible. Fortunately our treatment programs give you the path to healing/recovery. Through our intensive outpatient program, we give you the tools to manage your addiction in the most healthy way possible. To learn more, reach out to us today. </p>
                </Fade>
            </div>
            <div id="iop-two">
                <Fade left>
                    <LazyLoadImage src={flowerField} alt="by Raquel Pedrotti" />
                </Fade>
                <Fade right>
                    <div id="iop-two-text">
            ...
            <div id="iop-three">
                ...
                <Fade right>
                    <LazyLoadImage src={danielR} alt="by Gavin Spears" />
                </Fade>
            </div>
            <div id="iop-four">
                <Fade left>
                    <LazyLoadImage src={rJames} alt="Richard James" />
                </Fade>
                <Fade right>
                    <div id="iop-four-text">
                        <h2>Learn about our other programs</h2>
                        <p>At Antioch Rehab, we provide several other avenues of addiction treatment. In addition to our partial hospitalization program, we offer:</p>
                        <li>
