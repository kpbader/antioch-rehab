...
import intricate from '../../assets/images/intricate-explorer-Z1KdsfkzzDY-unsplash.jpg';
...
function PHP() {
    ...
    return (
        <section id="php-page">
            ...
            <div id="php-two">
                <Fade left>
                    <LazyLoadImage src={dex} alt="by Dex" />
                </Fade>
                <Fade right>
                    <div id="php-two-text">
                        <h2>What is a PHP?</h2>
            ...
            <div id="php-three">
                ...
                <Fade right>
                    <LazyLoadImage src={alice} alt="by Alice T" />
                </Fade>
            </div>
            <div id="php-four">
                <Fade left>
                    <LazyLoadImage src={intricate} alt="Intricate Explorer" />
                </Fade>
                <Fade right>
